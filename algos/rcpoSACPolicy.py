...
class rcpoSACPolicy(DDPGPolicy):
    ...
    def _mse_optimizer(
        ...
        # RCPO: add discounted lambda
        discounted_c = batch.info.c.flatten()*batch.info.rcpo_lambda.flatten()
        discounted_c = to_torch_as(discounted_c,batch.returns)
        current_q = critic(batch.obs, batch.act).flatten()
        target_q = batch.returns.flatten()-discounted_c
